...
//-----------------------------------------------------------------------------
#include "core/consts.h"                    // defined constants
#include "core/macros.h"                    // macros used throughout SWMM
#include "core/enums.h"                     // enumerated variables
#include "core/error.h"                     // error message codes
#include "core/datetime.h"                  // date/time functions
#include "core/objects.h"                   // definitions of SWMM's data objects
#include "core/funcs.h"                     // declaration of all global functions
#include "core/text.h"                      // listing of all text strings
#define  EXTERN                        // defined as 'extern' in headers.h
#include "core/globals.h"                   // declaration of all global variables

#include "core/swmm5.h"                     // declaration of exportable functions
