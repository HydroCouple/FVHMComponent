...
////  Shared variables    
////-----------------------------------------------------------------------------
//static INT4      project->IDStartPos;           // starting file position of ID names
//static INT4      project->InputStartPos;        // starting file position of input data
//static INT4      project->OutputStartPos;       // starting file position of output data
//static INT4      project->BytesPerPeriod;       // bytes saved per simulation time period
//static INT4      project->NsubcatchResults;     // number of subcatchment output variables
//static INT4      project->NnodeResults;         // number of node output variables
//static INT4      project->NlinkResults;         // number of link output variables
//static INT4      project->NumSubcatch;          // number of subcatchments reported on
//static INT4      project->NumNodes;             // number of nodes reported on
//static INT4      project->NumLinks;             // number of links reported on
//static INT4      project->NumPolluts;           // number of pollutants reported on
//static REAL4     project->SysResults[MAX_SYS_RESULTS];    // values of system output vars.

//-----------------------------------------------------------------------------
//  Exportable variables (shared with report.c)
//-----------------------------------------------------------------------------
//REAL4*           project->SubcatchResults;
//REAL4*           project->NodeResults;
//REAL4*           project->LinkResults;
